...
class DetailKotor extends SystemModel
{
    ...
    protected $primaryKey = 'detail_kotor_id';
     ...
     */
    protected $fillable = ['kotor_id', 'kotor_code_scan', 'kotor_code_packing', 'kotor_code_bersih', 'kotor_code_customer', 'kotor_id_category', 'kotor_id_jenis', 'kotor_scan', 'kotor_qc', 'kotor_bersih', 'kotor_pending', 'kotor_tanggal', 'kotor_created_at', 'kotor_created_by', 'kotor_updated_at', 'kotor_updated_by', 'kotor_deleted_at', 'kotor_deleted_by', 'kotor_qc_at', 'kotor_qc_by', 'kotor_bersih_at', 'kotor_bersih_by'];
