    ...
    <x-form :model="$model">
        <x-card>
            ...
            <div class="row">
                ...
                <x-form-select id="customer" :default="request()->get('customer') ?? $model->jenis_code_customer ?? null" col="6" id="customer" name="jenis_code_customer" label="Customer" :options="$customer" />
